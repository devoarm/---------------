  ...
  <div id="page-top">
    ...
    <div id="wrapper">
      ...
      >
        ...
        <!-- Heading -->
        <div class="sidebar-heading" v-if="currentUser.role == 'admin'">Addmin</div>
        ...
        <li class="nav-item" v-if="currentUser.role == 'admin'">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              <NuxtLink class="collapse-item" to="/admin/user">ข้อมูลผู้ใช้</NuxtLink>
              ...
              <a class="collapse-item" href="district.php">เขต / อำเภอ</a>
